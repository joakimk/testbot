...
* The testbot test suite is continuously run by a CI server using Ruby 1.8.7, 1.9.2 and Rubinius 1.1.1 (not 100% passing) to
  keep it compatible with as many of the ruby runtimes as possible (JRuby is on the todo list).
