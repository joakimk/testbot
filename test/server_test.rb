...
class ServerTest < Test::Unit::TestCase
  ...
  context "POST /jobs" do
    ...
    should "save a job and return the id" do
      post '/jobs', :files => 'spec/models/car_spec.rb spec/models/house_spec.rb', :root => 'server:/path/to/project', :type => 'rspec', :root_type => 'rsync'
      first_job = Job.first
      ...
      assert_equal 'rsync', first_job[:root_type]
    end
  ...
  context "GET /jobs/next" do
    ...
    should "be able to return a job and mark it as taken" do
      job1 = Job.create :files => 'spec/models/car_spec.rb', :root => 'server:/project', :type => 'rspec', :root_type => 'rsync'
    ...
    should "not return a job that has already been taken" do
      ...
      job2 = Job.create :files => 'spec/models/house_spec.rb', :root => 'server:/project', :type => 'rspec', :root_type => "rsync"
      get '/jobs/next', :version => Server.version
      assert last_response.ok?
